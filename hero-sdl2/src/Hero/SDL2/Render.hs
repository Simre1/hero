...
runGraphics :: forall i o m. GraphicsConfig -> System i o -> System i o
...
renderEntities :: (Graphics, V2 Float, V2 Float -> V2 Float) -> (Maybe Position2D, Maybe Rotation2D, Render) -> IO ()
